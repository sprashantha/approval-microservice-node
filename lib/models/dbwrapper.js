...
module.exports.setupMongoConnection = function(context, callback) {
        ...
        if (connErr) {
            ...
            context.gatedDb.collection('User', function (dbErr, userCollection) {
                if (dbErr) {
                    ...
                    logger.info("Empty user collection");
                }
            });
        }
        callback();
...
module.exports.setupRedisConnection = function(context, callback) {
